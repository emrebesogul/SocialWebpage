            ...
            <div>
                ...
                <div id="profile-header">
                    ...
                    <div>
                        ...
                        {this.state.pictureExists ? <div><Image id="profile-header-picture" src={"http://localhost:8000" + this.state.pictureURL} /> </div> : <div><Image id="profile-header-picture" src="/assets/images/user.png"></Image></div> }
