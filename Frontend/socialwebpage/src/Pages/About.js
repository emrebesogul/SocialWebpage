        ...
        <div >
          <div className="settings">
            <div className="account-settings">
              <Image id="about-logo" src="/assets/images/logo_high_res.png" />
              <p className="about-text">
                Founded in early 2018 by the three students, Emre Besogul, Konstantin Klaeger and Johannes Maendle,
